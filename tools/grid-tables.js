...
// ── emit ───────────────────────────────────────────────────────────────────
// Was `.replace(/\n/g, '\n')`, which replaced a newline with a newline and did
// nothing at all. Removed rather than corrected: the output is already what it
// should be, so there was never a transformation to restore.
